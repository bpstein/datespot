...
--
-- Host: localhost
-- Generation Time: Jul 28, 2015 at 08:41 AM
...
CREATE TABLE IF NOT EXISTS `ds_venue_image` (
  ...
  KEY `venue_image_unique_id` (`venue_image_unique_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Photos or images to be uploaded for a particular venue' AUTO_INCREMENT=1 ;
